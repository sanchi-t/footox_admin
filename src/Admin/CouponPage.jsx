      ...
      >
        <Flex
          ...
          >
            ...
            <Box w="10%" ><Text fontSize='1.2em' fontWeight='bold'>LIMIT</Text></Box>
            <Box w="10%" ><Text fontSize='1.2em' fontWeight='bold'>DISCOUNT</Text></Box>
            ...
            <Box w="15%" ><Text fontSize='1.2em' fontWeight='bold'>PRODUCT</Text></Box>
        ...
        {products.map((item, index) => (
          ...
          >
            ...
            <Box w="10%" >{item.type==="percentage" ? '':'₹'}{item.value}{item.type==="percentage" ? '%':''}</Box>
            ...
            <Box w="15%" >{item.Id===null||item.Id===undefined?'none':item.Id}</Box>
